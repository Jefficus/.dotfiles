" File: vim-jdown-wikilinks.vim
" Author: Jefferson Smith 
" Version: 0.1
" Last Modified: December 26, 2018
" Based On Work By: Henri Bourcereau 
"
" "vim-jdown-wikilink" is a Vim plugin which eases the navigation between files 
" in a personnal wiki
"
" Links are defined by double square brackers [[Like This]] and link 
" to "Like This.md" in the local directory.
"
" Installation
" ------------
" Copy the file into the $HOME/.vim/plugin/ directory
"
" Usage
" -----
" Link creation : 
